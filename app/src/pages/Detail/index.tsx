...
import { View, StyleSheet, TouchableOpacity, Image, Text, Linking, TextInput } from 'react-native'; 
...
const Detail = () =>{
    ...
    function handleWhatsapp(){
        Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Coleta de Residuos`)
    }
